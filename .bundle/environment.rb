...
module Bundler
  LOCKED_BY    = '0.9.7'
  FINGERPRINT  = "de1800ce079e411859b785b3c9fd5d3cb5f172df"
  AUTOREQUIRES = {:default=>[["liquid", false], ["will_paginate", false], ["subdomain-fu", false], ["acts_as_list", true], ["authlogic", false], ["httparty", false], ["paperclip", false], ["right_aws", false], ["rails", false]], :development=>[["sqlite3-ruby", false], ["rack-environment", false]]}
  SPECS        = [
        ...
        {:load_paths=>["/Users/mhuss/Code/tg/appmarkit/vendor/bundler_gems/gems/right_http_connection-1.2.4/lib"], :loaded_from=>"/Users/mhuss/Code/tg/appmarkit/vendor/bundler_gems/specifications/right_http_connection-1.2.4.gemspec"},
        {:load_paths=>["/Users/mhuss/Code/tg/appmarkit/vendor/bundler_gems/gems/right_aws-1.10.0/lib"], :loaded_from=>"/Users/mhuss/Code/tg/appmarkit/vendor/bundler_gems/specifications/right_aws-1.10.0.gemspec"},
